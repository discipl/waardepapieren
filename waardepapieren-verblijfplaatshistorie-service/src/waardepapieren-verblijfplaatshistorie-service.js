...
class WaardenpapierenVerblijfplaatshistorieService {
  constructor (core) {
    this.core = core
  }
  async start (configuration) {
    this.logger = log.getLogger('WaardepapierenVerblijfplaatshistorieService')
...
export default WaardenpapierenVerblijfplaatshistorieService
