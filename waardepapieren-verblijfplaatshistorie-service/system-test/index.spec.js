...
import WaardenpapierenVerblijfplaatshistorieService from '../src/waardepapieren-verblijfplaatshistorie-service'
...
describe('waardenpapieren-service', function () {
  ...
  it('should serve an expressed need for BRP', async () => {
    ...
    // Set up server
    let waardenpapierenVerblijfplaatshistorieService = new WaardenpapierenVerblijfplaatshistorieService(abundance.getCoreAPI())
    await waardenpapierenVerblijfplaatshistorieService.start(CONFIGURATION)
    ...
    await waardenpapierenVerblijfplaatshistorieService.stop()
  })
})
